...
import type { TDegree, TFiller, TSize, TCacheCanvasDimensions, TClassProperties } from '../../typedefs';
...
export declare class FabricObject<Props extends TProps<ObjectProps> = Partial<ObjectProps>, SProps extends SerializedObjectProps = SerializedObjectProps, EventSpec extends ObjectEvents = ObjectEvents> extends AnimatableObject<EventSpec> implements ObjectProps {
     ...
     * @return {Object} Object representation of an instance
     */
    toDatalessObject(propertiesToInclude?: string[]): { [R in Exclude<{ [K in keyof this]: this[K] extends Function ? never : K; }[keyof this], keyof SProps> | Exclude<keyof Props, keyof SProps>]: Omit<Props & TClassProperties<this>, keyof SProps>[Exclude<{ [K in keyof this]: this[K] extends Function ? never : K; }[keyof this], keyof SProps> | Exclude<keyof Props, keyof SProps>]; } & SProps;
    /**
     * @private
     * @param {Object} object
     */
