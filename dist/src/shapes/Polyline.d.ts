...
export declare class Polyline extends FabricObject {
     ...
     */
    static fromObject(object: Record<string, unknown>): Promise<import("./Object/Object").FabricObject<Partial<import("./Object/types/ObjectProps").ObjectProps>, import("./Object/types").SerializedObjectProps, import("../EventTypeDefs").ObjectEvents>>;
}
